# PostV2ListsListEntriesQueryEntryValuesCountryCode
...
```typescript
import { PostV2ListsListEntriesQueryEntryValuesCountryCode } from "attio-js/models/operations";

let value: PostV2ListsListEntriesQueryEntryValuesCountryCode = "US";
```
