...
export function tasksDeleteV2TasksTaskId(
  ...
  Result<
    ...
    | errors.DeleteV2TasksTaskIdResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteV2TasksTaskIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.DeleteV2TasksTaskIdResponseBody$inboundSchema),
    M.jsonErr(404, errors.DeleteV2TasksTaskIdResponseBody$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
