...
```typescript
import { GetV2ListsListEntriesEntryIdAttributesAttributeValuesDataCountryCode } from "attio-js/models/operations";

let value:
  GetV2ListsListEntriesEntryIdAttributesAttributeValuesDataCountryCode = "US";
```
