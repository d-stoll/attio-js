...
export function attributesPostV2TargetIdentifierAttributesAttributeStatuses(
  ...
  Result<
    ...
    | errors.PostV2TargetIdentifierAttributesAttributeStatusesAttributesResponseBody
    | errors.PostV2TargetIdentifierAttributesAttributeStatusesAttributesResponseResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
