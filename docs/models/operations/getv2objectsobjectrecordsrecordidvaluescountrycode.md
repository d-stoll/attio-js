# GetV2ObjectsObjectRecordsRecordIdValuesCountryCode
...
```typescript
import { GetV2ObjectsObjectRecordsRecordIdValuesCountryCode } from "attio-js/models/operations";

let value: GetV2ObjectsObjectRecordsRecordIdValuesCountryCode = "US";
```
