...
import {
  ...
  useAttributesStatusesCreateMutation
} from "attio-js/react-query/attributesStatusesCreate.js";
```
...
import {
  // Mutation hook for triggering the API call.
  useAttributesStatusesUpdateMutation
} from "attio-js/react-query/attributesStatusesUpdate.js";
```
