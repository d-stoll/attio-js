# PatchV2ObjectsObjectRecordsRecordIdValuesCountryCode
...
```typescript
import { PatchV2ObjectsObjectRecordsRecordIdValuesCountryCode } from "attio-js/models/operations";

let value: PatchV2ObjectsObjectRecordsRecordIdValuesCountryCode = "US";
```
