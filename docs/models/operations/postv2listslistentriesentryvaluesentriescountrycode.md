# PostV2ListsListEntriesEntryValuesEntriesCountryCode
...
```typescript
import { PostV2ListsListEntriesEntryValuesEntriesCountryCode } from "attio-js/models/operations";

let value: PostV2ListsListEntriesEntryValuesEntriesCountryCode = "US";
```
