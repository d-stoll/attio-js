...
export function listsPostV2Lists(
  ...
  Result<
    ...
    | errors.PostV2ListsListsResponseResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  >(
    ...
    M.jsonErr(400, errors.PostV2ListsResponseBody$inboundSchema),
    M.jsonErr(403, errors.PostV2ListsListsResponseBody$inboundSchema),
    M.jsonErr(404, errors.PostV2ListsListsResponseResponseBody$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
