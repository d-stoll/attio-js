# PostV2ObjectsObjectRecordsValuesCountryCode
...
```typescript
import { PostV2ObjectsObjectRecordsValuesCountryCode } from "attio-js/models/operations";

let value: PostV2ObjectsObjectRecordsValuesCountryCode = "US";
```
