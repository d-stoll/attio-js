# PostV2TargetIdentifierAttributesTypeEnum
...
```typescript
import { PostV2TargetIdentifierAttributesTypeEnum } from "attio-js/models/operations/postv2targetidentifierattributes.js";

let value: PostV2TargetIdentifierAttributesTypeEnum = "text";
```
