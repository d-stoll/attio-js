# PutV2ObjectsObjectRecordsRecordIdValuesRecordsCountryCode
...
```typescript
import { PutV2ObjectsObjectRecordsRecordIdValuesRecordsCountryCode } from "attio-js/models/operations";

let value: PutV2ObjectsObjectRecordsRecordIdValuesRecordsCountryCode = "US";
```
