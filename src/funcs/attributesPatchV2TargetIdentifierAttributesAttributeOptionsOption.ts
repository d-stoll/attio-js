...
export function attributesPatchV2TargetIdentifierAttributesAttributeOptionsOption(
  ...
  Result<
    ...
    | errors.PatchV2TargetIdentifierAttributesAttributeOptionsOptionResponseBody
    | errors.PatchV2TargetIdentifierAttributesAttributeOptionsOptionAttributesResponseBody
    | errors.PatchV2TargetIdentifierAttributesAttributeOptionsOptionAttributesResponseResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
