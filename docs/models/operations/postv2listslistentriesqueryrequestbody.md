...
```typescript
import { PostV2ListsListEntriesQueryRequestBody } from "attio-js/models/operations";
...
| `sorts`                                                                                                                                   | *operations.PostV2ListsListEntriesQuerySorts*[]                                                                                           | :heavy_minus_sign:                                                                                                                        | An object used to sort results. See the [full guide to filtering and sorting here](/docs/filtering-and-sorting).                          | [<br/>{<br/>"direction": "asc",<br/>"attribute": "name",<br/>"field": "last_name"<br/>}<br/>]                                             |
