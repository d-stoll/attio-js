...
export function recordsPatchV2ObjectsObjectRecordsRecordId(
  ...
  Result<
    ...
    | errors.PatchV2ObjectsObjectRecordsRecordIdResponseBody
    | errors.PatchV2ObjectsObjectRecordsRecordIdRecordsResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.PatchV2ObjectsObjectRecordsRecordIdResponseBody$inboundSchema,
    ),
    M.jsonErr(
      404,
      errors
