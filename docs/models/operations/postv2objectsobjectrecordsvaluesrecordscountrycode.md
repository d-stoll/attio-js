# PostV2ObjectsObjectRecordsValuesRecordsCountryCode
...
```typescript
import { PostV2ObjectsObjectRecordsValuesRecordsCountryCode } from "attio-js/models/operations";

let value: PostV2ObjectsObjectRecordsValuesRecordsCountryCode = "US";
```
