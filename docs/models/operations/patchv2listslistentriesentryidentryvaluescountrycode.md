# PatchV2ListsListEntriesEntryIdEntryValuesCountryCode
...
```typescript
import { PatchV2ListsListEntriesEntryIdEntryValuesCountryCode } from "attio-js/models/operations";

let value: PatchV2ListsListEntriesEntryIdEntryValuesCountryCode = "US";
```
