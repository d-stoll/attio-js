...
export function entriesGetV2ListsListEntriesEntryIdAttributesAttributeValues(
  ...
  Result<
    ...
    | errors.GetV2ListsListEntriesEntryIdAttributesAttributeValuesResponseBody
    | errors.GetV2ListsListEntriesEntryIdAttributesAttributeValuesEntriesResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
