...
export function listsGetV2ListsList(
  ...
  Result<
    operations.GetV2ListsListResponseBody,
    | errors.GetV2ListsListResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetV2ListsListRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetV2ListsListResponseBody$inboundSchema),
    M.jsonErr(404, errors.GetV2ListsListResponseBody$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
