...
export function tasksGetV2TasksTaskId(
  ...
  Result<
    operations.GetV2TasksTaskIdResponseBody,
    | errors.GetV2TasksTaskIdResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetV2TasksTaskIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetV2TasksTaskIdResponseBody$inboundSchema),
    M.jsonErr(404, errors.GetV2TasksTaskIdResponseBody$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
