...
export function attributesPatchV2TargetIdentifierAttributesAttributeStatusesStatus(
  ...
  Result<
    ...
    | errors.PatchV2TargetIdentifierAttributesAttributeStatusesStatusResponseBody
    | errors.PatchV2TargetIdentifierAttributesAttributeStatusesStatusAttributesResponseBody
    | errors.PatchV2TargetIdentifierAttributesAttributeStatusesStatusAttributesResponseResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
