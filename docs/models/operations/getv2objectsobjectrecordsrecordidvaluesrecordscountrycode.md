# GetV2ObjectsObjectRecordsRecordIdValuesRecordsCountryCode
...
```typescript
import { GetV2ObjectsObjectRecordsRecordIdValuesRecordsCountryCode } from "attio-js/models/operations";

let value: GetV2ObjectsObjectRecordsRecordIdValuesRecordsCountryCode = "US";
```
