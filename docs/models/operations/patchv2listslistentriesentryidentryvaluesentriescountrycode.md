# PatchV2ListsListEntriesEntryIdEntryValuesEntriesCountryCode
...
```typescript
import { PatchV2ListsListEntriesEntryIdEntryValuesEntriesCountryCode } from "attio-js/models/operations";

let value: PatchV2ListsListEntriesEntryIdEntryValuesEntriesCountryCode = "US";
```
