# PostV2ObjectsObjectRecordsQueryValuesCountryCode
...
```typescript
import { PostV2ObjectsObjectRecordsQueryValuesCountryCode } from "attio-js/models/operations";

let value: PostV2ObjectsObjectRecordsQueryValuesCountryCode = "US";
```
