# GetV2ListsListEntriesEntryIdEntryValuesEntriesCountryCode
...
```typescript
import { GetV2ListsListEntriesEntryIdEntryValuesEntriesCountryCode } from "attio-js/models/operations";

let value: GetV2ListsListEntriesEntryIdEntryValuesEntriesCountryCode = "US";
```
