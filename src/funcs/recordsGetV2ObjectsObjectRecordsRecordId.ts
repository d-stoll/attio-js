...
export function recordsGetV2ObjectsObjectRecordsRecordId(
  ...
  Result<
    ...
    | errors.GetV2ObjectsObjectRecordsRecordIdResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetV2ObjectsObjectRecordsRecordIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.GetV2ObjectsObjectRecordsRecordIdResponseBody$inboundSchema,
    ),
    M.jsonErr(
      404,
      errors.GetV2ObjectsObjectRecordsRecordIdResponseBody$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
