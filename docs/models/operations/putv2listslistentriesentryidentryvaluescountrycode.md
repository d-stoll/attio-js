# PutV2ListsListEntriesEntryIdEntryValuesCountryCode
...
```typescript
import { PutV2ListsListEntriesEntryIdEntryValuesCountryCode } from "attio-js/models/operations";

let value: PutV2ListsListEntriesEntryIdEntryValuesCountryCode = "US";
```
