# PutV2ObjectsObjectRecordsValuesCountryCode
...
```typescript
import { PutV2ObjectsObjectRecordsValuesCountryCode } from "attio-js/models/operations";

let value: PutV2ObjectsObjectRecordsValuesCountryCode = "US";
```
