# PutV2ListsListEntriesEntryValuesCountryCode
...
```typescript
import { PutV2ListsListEntriesEntryValuesCountryCode } from "attio-js/models/operations";

let value: PutV2ListsListEntriesEntryValuesCountryCode = "US";
```
