# PutV2ListsListEntriesEntryIdEntryValuesEntriesCountryCode
...
```typescript
import { PutV2ListsListEntriesEntryIdEntryValuesEntriesCountryCode } from "attio-js/models/operations";

let value: PutV2ListsListEntriesEntryIdEntryValuesEntriesCountryCode = "US";
```
