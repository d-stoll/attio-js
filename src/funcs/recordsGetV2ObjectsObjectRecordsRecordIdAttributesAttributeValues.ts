...
export function recordsGetV2ObjectsObjectRecordsRecordIdAttributesAttributeValues(
  ...
  Result<
    ...
    | errors.GetV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesResponseBody
    | errors.GetV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesRecordsResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
