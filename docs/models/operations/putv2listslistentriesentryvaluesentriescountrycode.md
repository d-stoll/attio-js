# PutV2ListsListEntriesEntryValuesEntriesCountryCode
...
```typescript
import { PutV2ListsListEntriesEntryValuesEntriesCountryCode } from "attio-js/models/operations";

let value: PutV2ListsListEntriesEntryValuesEntriesCountryCode = "US";
```
