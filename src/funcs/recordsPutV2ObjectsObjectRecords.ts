...
export function recordsPutV2ObjectsObjectRecords(
  ...
  Result<
    ...
    | errors.PutV2ObjectsObjectRecordsResponseBody
    | errors.PutV2ObjectsObjectRecordsRecordsResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PutV2ObjectsObjectRecordsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.PutV2ObjectsObjectRecordsResponseBody$inboundSchema),
    M.jsonErr(400, errors.PutV2ObjectsObjectRecordsResponseBody$inboundSchema),
    M.jsonErr(
      404,
      errors.PutV2ObjectsObjectRecordsRecordsResponseBody$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
