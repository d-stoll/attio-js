...
export function entriesPostV2ListsListEntriesQuery(
  ...
  Result<
    ...
    | errors.PostV2ListsListEntriesQueryResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostV2ListsListEntriesQueryRequest$outboundSchema.parse(value),
  ...
  >(
    M.json(
      200,
      operations.PostV2ListsListEntriesQueryResponseBody$inboundSchema,
    ),
    M.jsonErr(
      404,
      errors.PostV2ListsListEntriesQueryResponseBody$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
