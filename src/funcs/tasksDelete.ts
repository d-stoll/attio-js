...
import {
  ...
  GetV2TasksTaskIdNotFoundError$inboundSchema,
...
import {
  ...
  DeleteV2TasksTaskIdRequest$outboundSchema,
  DeleteV2TasksTaskIdResponse,
  DeleteV2TasksTaskIdResponse$inboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => DeleteV2TasksTaskIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, DeleteV2TasksTaskIdResponse$inboundSchema),
    M.jsonErr(404, GetV2TasksTaskIdNotFoundError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
