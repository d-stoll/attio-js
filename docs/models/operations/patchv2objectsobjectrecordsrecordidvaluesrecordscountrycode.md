# PatchV2ObjectsObjectRecordsRecordIdValuesRecordsCountryCode
...
```typescript
import { PatchV2ObjectsObjectRecordsRecordIdValuesRecordsCountryCode } from "attio-js/models/operations";

let value: PatchV2ObjectsObjectRecordsRecordIdValuesRecordsCountryCode = "US";
```
