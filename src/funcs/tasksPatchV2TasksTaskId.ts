...
export function tasksPatchV2TasksTaskId(
  ...
  Result<
    ...
    | errors.PatchV2TasksTaskIdTasksResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  >(
    ...
    M.jsonErr(400, errors.PatchV2TasksTaskIdResponseBody$inboundSchema),
    M.jsonErr(404, errors.PatchV2TasksTaskIdTasksResponseBody$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
