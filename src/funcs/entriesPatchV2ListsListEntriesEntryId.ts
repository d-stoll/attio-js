...
export function entriesPatchV2ListsListEntriesEntryId(
  ...
  Result<
    ...
    | errors.PatchV2ListsListEntriesEntryIdResponseBody
    | errors.PatchV2ListsListEntriesEntryIdEntriesResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PatchV2ListsListEntriesEntryIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.PatchV2ListsListEntriesEntryIdResponseBody$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.PatchV2ListsListEntriesEntryIdResponseBody$inboundSchema,
    ),
    M.jsonErr(
      404,
      errors.PatchV2ListsListEntriesEntryIdEntriesResponseBody$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
