...
import {
  ...
  GetV2TasksTaskIdRequest$outboundSchema,
  GetV2TasksTaskIdResponse,
  GetV2TasksTaskIdResponse$inboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetV2TasksTaskIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, GetV2TasksTaskIdResponse$inboundSchema),
