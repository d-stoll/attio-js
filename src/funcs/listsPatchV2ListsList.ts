...
export function listsPatchV2ListsList(
  ...
  Result<
    operations.PatchV2ListsListResponseBody,
    | errors.PatchV2ListsListResponseBody
    | errors.PatchV2ListsListListsResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PatchV2ListsListRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.PatchV2ListsListResponseBody$inboundSchema),
    M.jsonErr(400, errors.PatchV2ListsListResponseBody$inboundSchema),
    M.jsonErr(404, errors.PatchV2ListsListListsResponseBody$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
