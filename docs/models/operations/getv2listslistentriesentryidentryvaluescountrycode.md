# GetV2ListsListEntriesEntryIdEntryValuesCountryCode
...
```typescript
import { GetV2ListsListEntriesEntryIdEntryValuesCountryCode } from "attio-js/models/operations";

let value: GetV2ListsListEntriesEntryIdEntryValuesCountryCode = "US";
```
