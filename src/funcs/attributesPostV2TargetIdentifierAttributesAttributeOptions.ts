...
export function attributesPostV2TargetIdentifierAttributesAttributeOptions(
  ...
  Result<
    ...
    | errors.PostV2TargetIdentifierAttributesAttributeOptionsResponseBody
    | errors.PostV2TargetIdentifierAttributesAttributeOptionsAttributesResponseBody
    | errors.PostV2TargetIdentifierAttributesAttributeOptionsAttributesResponseResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
