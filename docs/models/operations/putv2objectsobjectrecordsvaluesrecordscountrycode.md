# PutV2ObjectsObjectRecordsValuesRecordsCountryCode
...
```typescript
import { PutV2ObjectsObjectRecordsValuesRecordsCountryCode } from "attio-js/models/operations";

let value: PutV2ObjectsObjectRecordsValuesRecordsCountryCode = "US";
```
