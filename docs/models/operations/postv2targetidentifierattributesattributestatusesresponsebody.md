...
```typescript
import { PostV2TargetIdentifierAttributesAttributeStatusesResponseBody } from "attio-js/models/operations";

let value: PostV2TargetIdentifierAttributesAttributeStatusesResponseBody = {
  data: {
    id: {
