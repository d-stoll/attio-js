# PutV2ObjectsObjectRecordsRecordIdValuesCountryCode
...
```typescript
import { PutV2ObjectsObjectRecordsRecordIdValuesCountryCode } from "attio-js/models/operations";

let value: PutV2ObjectsObjectRecordsRecordIdValuesCountryCode = "US";
```
