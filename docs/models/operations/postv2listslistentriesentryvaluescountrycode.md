# PostV2ListsListEntriesEntryValuesCountryCode
...
```typescript
import { PostV2ListsListEntriesEntryValuesCountryCode } from "attio-js/models/operations";

let value: PostV2ListsListEntriesEntryValuesCountryCode = "US";
```
