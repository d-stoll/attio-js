...
export function webhooksGetV2WebhooksWebhookId(
  ...
  Result<
    ...
    | errors.GetV2WebhooksWebhookIdResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetV2WebhooksWebhookIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetV2WebhooksWebhookIdResponseBody$inboundSchema),
    M.jsonErr(404, errors.GetV2WebhooksWebhookIdResponseBody$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
