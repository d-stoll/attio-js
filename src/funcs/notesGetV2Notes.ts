...
export function notesGetV2Notes(
  ...
  Result<
    operations.GetV2NotesResponseBody,
    | errors.GetV2NotesResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetV2NotesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetV2NotesResponseBody$inboundSchema),
    M.jsonErr(404, errors.GetV2NotesResponseBody$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
