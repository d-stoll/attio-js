...
export function tasksPostV2Tasks(
  ...
  Result<
    ...
    | errors.PostV2TasksResponseBody
    | errors.PostV2TasksTasksResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  >(
    ...
    M.jsonErr(400, errors.PostV2TasksResponseBody$inboundSchema),
    M.jsonErr(404, errors.PostV2TasksTasksResponseBody$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
