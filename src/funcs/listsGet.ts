...
import {
  ...
  GetV2ListsListRequest$outboundSchema,
  GetV2ListsListResponse,
  GetV2ListsListResponse$inboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetV2ListsListRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetV2ListsListResponse$inboundSchema),
