...
export function recordsPutV2ObjectsObjectRecordsRecordId(
  ...
  Result<
    ...
    | errors.PutV2ObjectsObjectRecordsRecordIdResponseBody
    | errors.PutV2ObjectsObjectRecordsRecordIdRecordsResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PutV2ObjectsObjectRecordsRecordIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.PutV2ObjectsObjectRecordsRecordIdResponseBody$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.PutV2ObjectsObjectRecordsRecordIdResponseBody$inboundSchema,
    ),
    M.jsonErr(
      404,
      errors.PutV2ObjectsObjectRecordsRecordIdRecordsResponseBody$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
